...
- **Room-code API**: `RoomCode_Encode` / `RoomCode_Decode` / `RoomCode_NormalizeInput` at `room_code.h:96,104,113`; payload is 6 bytes (`ROOM_CODE_RAW_LEN` at `room_code.h:63`). Plan's derivation of the 6-byte payload from both sides is correct.
