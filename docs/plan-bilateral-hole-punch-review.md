...
- **Function signatures**: `host_thread_fn` at `direct_p2p.c:288` (plan cites the range correctly), `join_thread_fn` at `direct_p2p.c:2820` (plan says 372-457; actual is 372-458 — off by one, nit), `host_tick_receive` at `direct_p2p.c:2820` (plan cites 516-552, verified exactly), `do_handoff(1, …)` at `:550` verified exactly, `do_handoff(2, …)` at `:558` verified exactly.
