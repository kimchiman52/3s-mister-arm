...
- Import intent: phase 1 `MiSTer_3SX` HPS wrapper foundation
...
then the local 3SX-specific overlay files are applied on top.
...
diverge from upstream for the `MiSTer_3SX` wrapper build plus the Docker fallback context.
