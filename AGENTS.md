...
- Load [docs/agent-memory/mister-native-analog-crt.md](/Users/sb/Developer/3sx-mister/docs/agent-memory/mister-native-analog-crt.md) when revisiting scaler-off analog CRT output, `svideo`/`cvbs` color loss, `crt-4x3`, or native analog wrapper/video-path cleanup.
