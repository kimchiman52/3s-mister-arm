...
- [GekkoNet](https://github.com/HeatXD/GekkoNet) — P2P rollback netcode (desktop builds; experimental MiSTer netplay work on `netplay` branch, see `docs/archive/plan-netplay-port.md`)
